 ...
 * handled by a callback to alittle_comment which is
...
<?php endif; // check for comment navigation ?>
			...
			<ol>
				<?php
					 ...
					 * to use alittle_comment() to format the comments.
					 * If you want to overload this in a child theme then you can
					 * define alittle_comment() and that will be used instead.
					 * See alittle_comment() in boilerplate/functions.php for more.
					 */
					wp_list_comments( array( 'callback' => 'alittle_comment' ) );
				?>
			</ol>
