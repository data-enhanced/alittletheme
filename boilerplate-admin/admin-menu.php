...
/*	1)	Add "Boilerplate Admin" link to left-nav Admin Menu */
	...
	//	Add option if in Admin Page
		function create_alittle_admin_page() {
		//	add_theme_page( $page_title, $menu_title, $capability, $menu_slug, $function);
			add_theme_page('Boilerplate Admin', 'Boilerplate Admin', 'administrator', 'boilerplate-admin', 'build_alittle_admin_page');
		}
		add_action('admin_menu', 'create_alittle_admin_page');
