...
Fixed error in header.php, I was applying `alittle_filter_wp_title` as a `filter` to `wp_title` in functions.php,
but then calling `alittle_filter_wp_title` in header.php, rather than `wp_title`... der...  Thanks, Randy Runnels!
